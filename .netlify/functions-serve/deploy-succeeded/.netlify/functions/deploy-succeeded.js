    ...
    function parse(options) {
      ...
      if (!isBinaryRequest) {
        if (options.mediaType.format) {
          headers2.accept = headers2.accept.split(/,/).map((preview) => preview.replace(/application\/vnd(\.\w+)(\.v3)?(\.\w+)?(\+json)?$/, `application/vnd$1$2.${options.mediaType.format}`)).join(",");
        }
      ...
      if (!headers2["content-type"] && typeof body !== "undefined") {
    ...
    function fetchWrapper(requestOptions) {
      ...
      return fetch(requestOptions.url, Object.assign(
        ...
        if ("deprecation" in headers2) {
          ...
          log.warn(`[@octokit/request] "${requestOptions.method} ${requestOptions.url}" is deprecated. It is scheduled to be removed on ${headers2.sunset}${deprecationLink ? `. See ${deprecationLink}` : ""}`);
        }
...
` + data.errors.map((e) => ` - ${e.message}`).join("\n");
    ...
    var GraphqlResponseError = class extends Error {
      constructor(request2, headers2, response) {
    ...
    function graphql(request2, query, options) {
      ...
      return request2(requestOptions).then((response) => {
        if (response.data.errors) {
          ...
          throw new GraphqlResponseError(requestOptions, headers2, response.data);
        }
...
// .netlify/functions/deploy-succeeded.cjs
var fs = require("fs");
...
var FILES = ["404s.yml", "og_images.yml", "tags.json", "webmentions.json"];
var owner = "aarongustafson";
var repo = "aaron-gustafson.com";
var message = `Updated as part of Netlify build [skip netlify]`;
var headers = {
...
is-plain-object/dist/is-plain-object.js:
   ...
   *)
*/
//# sourceMappingURL=deploy-succeeded.js.map
