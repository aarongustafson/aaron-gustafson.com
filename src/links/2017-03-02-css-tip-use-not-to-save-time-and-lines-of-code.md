...
The `:not` selector has [pretty good support](https://caniuse.com/#feat=css-sel3) in its most basic form. Just be sure to [make sure the selector you’re _not_ electing is supported](https://caniuse.com/#feat=css-not-sel-list).
