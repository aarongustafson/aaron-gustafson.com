(function (window, document) {
	...
	var anchorable_elements = "h1 h2 h3 h4 h5 h6 figure .gist".split(" "),
		...
		anchor_svg =
			...
			prefix +
			'__icon" width="15" height="15" viewBox="0 0 8 8"><path d="M5.88.03c-.18.01-.36.03-.53.09-.27.1-.53.25-.75.47a.5.5 0 1 0 .69.69c.11-.11.24-.17.38-.22.35-.12.78-.07 1.06.22.39.39.39 1.04 0 1.44l-1.5 1.5c-.44.44-.8.48-1.06.47-.26-.01-.41-.13-.41-.13a.5.5 0 1 0-.5.88s.34.22.84.25c.5.03 1.2-.16 1.81-.78l1.5-1.5c.78-.78.78-2.04 0-2.81-.28-.28-.61-.45-.97-.53-.18-.04-.38-.04-.56-.03zm-2 2.31c-.5-.02-1.19.15-1.78.75l-1.5 1.5c-.78.78-.78 2.04 0 2.81.56.56 1.36.72 2.06.47.27-.1.53-.25.75-.47a.5.5 0 1 0-.69-.69c-.11.11-.24.17-.38.22-.35.12-.78.07-1.06-.22-.39-.39-.39-1.04 0-1.44l1.5-1.5c.4-.4.75-.45 1.03-.44.28.01.47.09.47.09a.5.5 0 1 0 .44-.88s-.34-.2-.84-.22z"/></svg>',
		anchor_message =
			'<b class="' +
			anchor_class +
			'__text">Click to get a link to this exact spot.</b>',
		anchor_notifier =
			'<strong aria-live="assertive" class="' + prefix + '__alert"></strong>',
		anchor_html = anchor_svg + anchor_message + anchor_notifier,
		// Alert
		alert_duration = 2000,
		success_message =
			'<b class="hidden">The link was </b>copied<b class="hidden"> to your clipboard.</b>',
		// Textarea
		$textarea,
		// Speech
	...
	while (length--) {
		anchorable_elements[length] =
			"main " + anchorable_elements[length] + "[id]";
	}
	...
	function createHiddenTextarea() {
		...
		$div.style =
			"position: fixed; left: 0px; top: 0px; width: 0px; height: 0px; z-index: 100; opacity: 0;";
