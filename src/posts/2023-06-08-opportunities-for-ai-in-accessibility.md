...
As Joe mentions, human-in-the-loop authoring of `alt` text should absolutely be a thing. And if AI can pop in to offer a starting point—even if that starting point is prompting you to say _What is this B.S.? That’s not right at all… let me fix it_—I think that’s a win.
