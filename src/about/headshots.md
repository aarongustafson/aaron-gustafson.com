...
<ul class="listing listing--gallery">
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/2022.jpg">
        <img src="{{ site.url }}/i/headshots/2022-sm.jpg" alt="" width="700" height="700">
      </a>
      <figcaption>1299px × 1299px. Headshot by <a href="https://www.instagram.com/sakopakphoto/">Sako Pak</a> circa 2022</figcaption>
    </figure>
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/2014.jpg">
        <img src="{{ site.url }}/i/headshots/2014-sm.jpg" alt="" width="700" height="700">
      </a>
  ...
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/2013.jpg">
        <img src="{{ site.url }}/i/headshots/2013-sm.jpg" alt="" width="700" height="700">
      </a>
  ...
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/2007.jpg">
        <img src="{{ site.url }}/i/headshots/2007-sm.jpg" alt="" width="700" height="700">
      </a>
  ...
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/doll.jpg">
        <img src="{{ site.url }}/i/headshots/doll-sm.jpg" alt="" width="700" height="700">
      </a>
  ...
  <li class="listing__item listing__item--photo">
    <figure>
      <a href="/i/headshots/avatar-cornell.jpg">
        <img src="{{ site.url }}/i/headshots/avatar-cornell-sm.png" alt="" width="700" height="720">
      </a>
