(function (document) {
	if (!("querySelector" in document) || !("closest" in document.body)) {
		return;
	}
	...
	function updateLightbox() {
		fadeIn(function () {
			$img.style.backgroundImage =
				"url(" + img_prefix + gallery[current_position].img + ")";
	...
	function open(e) {
		...
		current_position =
			$triggering_element.closest(item_selector).dataset.lightboxIndex;
