(function () {
	...
	function toggle($figure) {
		...
		$figure.querySelector("button.alt").innerText = showing
			? "Dismiss Alt"
			: "View Alt";
	...
	var $alt_button = document.createElement("button"),
		...
		$imgs = document.querySelectorAll(
			container_selector + ' img[alt]:not([alt=""])',
		),
		$style = document.createElement("style");

	$style.innerText =
		"button.alt { margin: 0; position: absolute; inset: 10px 10px auto auto; z-index: 1; } \
