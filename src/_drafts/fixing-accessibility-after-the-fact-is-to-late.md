# Ability Summit 2026: Fixing Accessibility After the Fact Is Too Late Panel Transcript
...
**Aaron:** Yeah, I love the idea of feeding our own bug data. I think that's such an unused treasure trove of information. And, similar to the GitHub team's experience, in my own tests, taking and remediating bad code coming from AI coding agents… remediating that manually and then feeding those diffs back to the agents resolved the issues 100% of the time going forward. So having that as part of the training corpus was really improved things.
...
Ed, I wanted to come over to you, and I actually wanted to ask you a little bit to talk about the [GitHub] Accessibility Scanner and some of the work that you're doing in the PR space. You made an interesting point as well in of our early discussions about this… about the opportunity for just-in-time training for engineers who are reviewing PRs from your accessibility agent.
...
Then she said, “OK, go fix these issues.” So no validation of whether the issues are correct, not this or that. Go ahead, fix these issues… and it turns out that the 30 issues that Claude tried to fix all at once was just inundated the context entirely. There were no guardrails, there was nothing. And talk about thrashing… This was a token burning. This is what's going on. I mean, people think like that.
...
**Navin:** Yeah, I mean, not everybody's like Ed. Not every company is like Microsoft… where you can try to build your own tools and this and that. Certainly, you can try. And if you're an average enterprise out there, do you want to be in the business of building accessibility, doing for yourself?
...
And [to the audience] I want to thank all of you for having us. If you don't mind taking a moment and for your feedback on the session, we would absolutely appreciate that as well.
